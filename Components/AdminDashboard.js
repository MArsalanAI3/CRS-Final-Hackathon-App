    ...
    <Text style={{
        ...
        textShadowColor: 'grey', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 5,
            ...
            <Content style={styles.start}>
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => { navigation.navigate('Students') }} style={{ backgroundColor: '#ffff', borderRadius: 10, padding: 20, paddingHorizontal: 25, alignItems: 'center', borderColor: "#13697d", borderWidth: 3, marginTop:1 }} >
                        ...
                        <TouchableOpacity activeOpacity={0.8} onPress={() => { navigation.navigate('Companies') }} style={{ backgroundColor: '#ffff', borderRadius: 10, padding: 20, paddingHorizontal: 26, elevation: 5, alignItems: 'center', borderColor: "#13697d", borderWidth: 3,marginTop:20 }} >
                        <Text style={{ fontSize: 15, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}></Text>
                            <Text style={{ fontSize: 25, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}> Company's </Text>
                            <Text style={{ fontSize: 15, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}></Text>
                        </TouchableOpacity>

                        <TouchableOpacity activeOpacity={0.8} onPress={() => { navigation.navigate('Vacancies') }} style={{ backgroundColor: '#ffff', borderRadius: 10, padding: 20, paddingHorizontal: 25, alignItems: 'center', borderColor: "#13697d", borderWidth: 3, marginTop:20 }} >
                        <Text style={{ fontSize: 15, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}></Text>
                            <Text style={{ fontSize: 25, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}>Vacancy's</Text>
                            <Text style={{ fontSize: 15, fontWeight: 'bold', color: "#13697d", textShadowColor: 'grey', textShadowOffset: { width: 0.1, height: 1 }, textShadowRadius: 2 }}></Text>
                        </TouchableOpacity>
